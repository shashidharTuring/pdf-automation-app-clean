...
# Constants
DRIVE_FOLDER_ID = "1zRSbrOpugIJBPpw2aTsjYGRJcPIEZMJh"  # 🔁 Replace with your actual shared Drive folder ID
...
# --- If trigger is True ---
if st.session_state.start_analysis and not st.session_state.stop_analysis:
    if not pdf_name:
...
if os.path.exists(csv_file_path):
    ...
    if os.path.exists(pdf_file):
        with open(pdf_file, "rb") as f:
            st.download_button("📄 Download Original PDF", f.read(), file_name=pdf_file, mime="application/pdf")
